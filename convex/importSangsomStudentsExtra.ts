...
export const importK15Students = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const students = [
            ...
            { nickname: "Pangping", thaiName: "ปังปิง" },
            { nickname: "CELINE", thaiName: "เซลีน" },
            { nickname: "CHILYN", thaiName: "ชายลิน" },
