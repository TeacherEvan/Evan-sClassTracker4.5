...
export default defineSchema({
  ...
  providers: defineTable({
    ...
    autoGenerationType: v.optional(v.union(  // Type of auto-generated provider
  ...
  classes: defineTable({
    ...
    providerId: v.optional(v.id("providers")), // Provider ID (auto-approves classes)
  ...
  students: defineTable({
    ...
    district: v.optional(v.string()), // District (e.g., "Sathon", "Pathum Wan") - For location-based duplicate detection
    province: v.optional(v.string()), // Province (e.g., "Bangkok", "Chiang Mai") - For location-based duplicate detection
    area: v.optional(v.string()), // Specific area/neighborhood (e.g., "Silom", "Sukhumvit") - For location-based duplicate detection
    ...
    .index("by_district", ["district"]) // District-based queries for duplicate detection
    .index("by_province", ["province"]) // Province-based queries for duplicate detection
