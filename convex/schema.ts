...
export default defineSchema({
  ...
  providers: defineTable({
    ...
    createdAt: v.number(),
    isAutoGenerated: v.optional(v.boolean()), // True for auto-generated providers (Evan'sPVTclass)
    isPrivateClassProvider: v.optional(v.boolean()), // True for "Evan'sPVTclass" auto-generated providers
  })
    .index("by_created_by", ["createdBy"])
    .index("by_category", ["category"])
    .index("by_active", ["isActive"])
    .index("by_auto_generated", ["isAutoGenerated"]) // NEW - Query auto-generated providers
    .index("by_private_class", ["isPrivateClassProvider"]), // NEW - Query private class providers
  ...
  students: defineTable({
    ...
    district: v.optional(v.string()), // District (e.g., "Bang Rak", "Sukhumvit")
    province: v.optional(v.string()), // Province (e.g., "Bangkok", "Chiang Mai")
    area: v.optional(v.string()), // Specific area/neighborhood (e.g., "Thonglor", "Ekkamai")
