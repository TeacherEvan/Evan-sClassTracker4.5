...
export const seedLatestUpdate = internalMutation({
    ...
    handler: async (ctx, args) => {
        ...
        const updateId = await ctx.db.insert("appUpdates", {
            ...
            description: "We've streamlined the booking process to save you time and reduce confusion. Everything is now clearer and more organized.",
            descriptionTh: "เราได้ปรับปรุงระบบการจองให้ง่ายขึ้น ประหยัดเวลา และลดความสับสน ทุกอย่างชัดเจนและเป็นระเบียบมากขึ้น",
            features: [
                {
                    icon: "CheckCircle2",
