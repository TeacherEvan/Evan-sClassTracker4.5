...
export const initializeDefaults = mutation({
  ...
  handler: async (ctx, { adminId }) => {
    ...
    const existing = await ctx.db.query("teacherResources").collect();
    ...
    const defaultResources = [
      {
        ...
        description:
          "World's largest marketplace for teacher-created resources including lesson plans, worksheets, and activities.",
        descriptionTh:
          "ตลาดขายทรัพยากรการสอนที่ใหญ่ที่สุดในโลก มีแผนการสอน แบบฝึกหัด และกิจกรรมที่ครูสร้างขึ้น",
      ...
      },
      {
        ...
        description:
          "28,000+ worksheets, games, and lesson plans for PreK-8th grade. Features interactive worksheets and guided lessons.",
        descriptionTh:
          "แบบฝึกหัด เกม และแผนการสอนมากกว่า 28,000 รายการสำหรับอนุบาล-ป.2 มีแบบฝึกหัดแบบโต้ตอบและบทเรียนแนะนำ",
      ...
      },
      {
        ...
        titleTh: "ReadWorks",
        description:
          "FREE reading comprehension resources with 6,000+ articles aligned to the science of reading for K-12 students.",
        descriptionTh:
          "ทรัพยากรความเข้าใจในการอ่านฟรี มีบทความกว่า 6,000 บทความสำหรับนักเรียนอนุบาล-ม.6",
      ...
      },
      {
        ...
        titleTh: "CommonLit",
        description:
          "FREE ELA curriculum for grades 6-12 with full-length texts, lesson materials, and benchmark assessments.",
        descriptionTh:
          "หลักสูตร ELA ฟรีสำหรับชั้น ม.1-ม.6 พร้อมข้อความเต็ม เอกสารบทเรียน และการประเมินมาตรฐาน",
      ...
      },
      {
        ...
        description:
          "FREE comprehensive learning platform covering math, science, arts, and humanities with personalized learning dashboard.",
        descriptionTh:
          "แพลตฟอร์มการเรียนรู้ฟรีที่ครอบคลุมคณิตศาสตร์ วิทยาศาสตร์ ศิลปะ และมนุษยศาสตร์ พร้อมแดชบอร์ดการเรียนรู้ส่วนบุคคล",
