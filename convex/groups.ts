...
export const addMembers = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (
      ...
      throw new Error(
        "Only group creator, moderators, or admins can add members",
      );
    }
...
export const removeMembers = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (
      ...
      throw new Error(
        "Only group creator, moderators, or admins can remove members",
      );
    }
...
export const deleteGroup = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (
      ...
      throw new Error(
        "Only group creator, moderators, or admins can delete groups",
      );
    }
...
export const updateName = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (
      ...
      throw new Error(
        "Only group creator, moderators, or admins can update group name",
      );
    }
