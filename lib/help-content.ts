    ...
    features: [
      {
        ...
        detailedDescription:
          "Add new students with bilingual names, assign them to schools, and manage their information. Each student gets a unique auto-generated ID. Search and filter students by school, name, or ID.",
        detailedDescriptionTh:
          "เพิ่มนักเรียนใหม่ด้วยชื่อสองภาษา กำหนดพวกเขาให้กับโรงเรียน และจัดการข้อมูลของพวกเขา นักเรียนแต่ละคนจะได้รับ ID ที่สร้างอัตโนมัติที่ไม่ซ้ำ ค้นหาและกรองนักเรียนตามโรงเรียน ชื่อ หรือ ID",
        steps: [
          {
            step: 1,
