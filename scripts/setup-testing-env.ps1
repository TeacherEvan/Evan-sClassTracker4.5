...
Write-Host "STEP 1: CREATE CONVEX TEST DEPLOYMENT" -ForegroundColor Yellow
...
Write-Host "STEP 2: CREATE DOCKER HUB ACCESS TOKEN" -ForegroundColor Yellow
...
Write-Host "STEP 3: ADD GITHUB REPOSITORY SECRETS" -ForegroundColor Yellow
...
Write-Host "STEP 4: INSTALL PLAYWRIGHT (run this now)" -ForegroundColor Yellow
Write-Host "   npm install -D @playwright/test" -ForegroundColor White
Write-Host "   npx playwright install" -ForegroundColor White
Write-Host ""

# Step 6: Docker Login
Write-Host "STEP 5: LOGIN TO DOCKER HUB (run this now)" -ForegroundColor Yellow
