...
>
> 1. **Isolate & Transcribe:** Look at only one image from the batch. Transcribe its content to create **Draft 1**.
...
> **FINAL OUTPUT:**
>
> After you have performed this entire loop for all the images, present the final, verified Markdown content for each file. Clearly separate each file's content.
>
> **Use this exact output format:**
>
> `---`
> [File 1: (Use image name or number)]
>
> (Final Markdown content for File 1)
>
> `---`
> [File 2: (Use image name or number)]
>
> (Final Markdown content for File 2)
>
> `---`
