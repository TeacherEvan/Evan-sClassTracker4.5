...
export function StudentManagement({ userId, userRole, userSchoolId }: StudentManagementProps) {
        ...
        <div className="space-y-6">
            ...
            {showFilters && (
                <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-4 animate-in fade-in slide-in-from-top-2">
                    ...
                    {(userRole === "admin" || userRole === "teacher") && (
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setSelectedSchoolId(e.target.value as Id<"schools"> || "all")}
                            ...
                            >
                                ...
                                <option value="provider">{t("Provider Students", "นักเรียนจากผู้ให้บริการ")}</option>
                            </select>
                        </div>
                    )}
                    ...
                    {(selectedSchoolId !== "all" || selectedGrade !== "all" || selectedClass !== "all") && (
