...
export function StudentFormModal({
    ...
    const updateField = (field: keyof StudentFormData, value: string | number | boolean | undefined) => {
                ...
                <form onSubmit={onSubmit} className="p-4 md:p-6 space-y-4 md:space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {t("Class", "คลาส")}{formData.schoolId ? " *" : ""}
                                </label>
                                <select
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-2">
                                    ...
                                    <ThailandLocationDropdown
                                        ...
                                        onProvinceChange={(code) => updateField("provinceCode", code)}
                                        onDistrictChange={(name) => updateField("districtName", name)}
                                        showLabels={true}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => updateField("secondaryParentName", e.target.value)}
                                                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => updateField("secondaryParentPhone", e.target.value)}
                                                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                                            />
                                        </div>
                                    </div>
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        >
                            {isSubmitting ? (
                                ...
                                isEditing ? t("Update Student", "อัปเดต") : t("Add Student", "เพิ่มนักเรียน")
                            )}
                        </button>
                        <button
                            type="button"
