      ...
      <div className="p-12 text-center text-gray-500 dark:text-gray-400">
        ...
        <p className="text-sm mt-2">
          {t(
            ...
            "เพิ่มนักเรียนคนแรกเพื่อเริ่มต้น",
          )}
        </p>
      </div>
    );
                ...
                renderItem={(student) => {
                  ...
                  return (
                    <table className="w-full">
                      <tbody>
                        <tr
                          className={`hover:bg-gray-50 dark:hover:bg-gray-900 quick-action-parent transition-colors ${isSelected ? "bg-blue-50 dark:bg-blue-900/20" : ""}`}
                        >
                            ...
                            <input
                              ...
                              aria-label={
                                language === "en"
                                  ...
                                  : `เลือกนักเรียน ${student.firstName} ${student.lastName}`
                              }
                            />
                          </td>
                          <td
                            className="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white"
                            style={{ width: "180px" }}
                          >
                            {student.studentId}
                          </td>
