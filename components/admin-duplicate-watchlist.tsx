...
export function AdminDuplicateWatchlist({
    ...
    const [selectedEntry, _setSelectedEntry] = useState<Id<"duplicateWatchlist"> | null>(null);
                    ...
                    <div className="grid grid-cols-5 gap-4 p-6 border-b bg-gray-50">
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-gray-600">{t("Total", "ทั้งหมด")}</p>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-gray-600">{t("Pending", "รอดำเนินการ")}</p>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-gray-600">{t("Reviewed", "ตรวจสอบแล้ว")}</p>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-gray-600">{t("Merged", "รวมแล้ว")}</p>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-gray-600">{t("Dismissed", "ปิดแล้ว")}</p>
                ...
                <div className="p-6 border-b">
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder={t("Search by name, ID, or grade...", "ค้นหาด้วยชื่อ, รหัส, หรือเกรด...")}
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-3">
                                                    <div>
                                                        <span className="font-medium">{t("Matches", "จำนวนที่ตรง")}:</span>{" "}
                                                        <span className="text-orange-600 font-bold">
                                                            {entry.matchedFields} {t("fields", "ฟิลด์")}
                                                        </span>
                                                    </div>
                                                    <div>
                                                        <span className="font-medium">{t("Duplicates", "ข้อมูลซ้ำ")}:</span>{" "}
                                            ...
                                            <div className="flex flex-col gap-2 ml-4">
                                                {entry.status === "pending" && (
                                                    <>
                                                        ...
                                                        >
                                                            {t("Mark Reviewed", "ทำเครื่องหมายว่าตรวจสอบแล้ว")}
                                                        </button>
                                                        <button
