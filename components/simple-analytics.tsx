...
export function SimpleAnalytics({
  ...
  const [analyticsView, setAnalyticsView] = useState<"statistics" | "logs">(
    "statistics",
  );

  // Check if user can view ClassCount (moderator or admin)
  const canViewClassCount =
  ...
  const classCount = useQuery(api.simpleAnalytics.getSchoolClassCount, {
    schoolId,
  });
  ...
  const weeklyComparison = useQuery(api.simpleAnalytics.getWeeklyComparison, {
    schoolId,
  });
            ...
            <div>
              <h2 className="text-3xl font-bold flex items-center gap-2">
                ...
                {t(
                  ...
                  "สถิติและการมีส่วนร่วมของชั้นเรียน",
                )}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4">
                  ...
                  <p className="text-xs text-indigo-600 dark:text-indigo-400 mt-1">
                    {engagementMetrics.editedClassesCount}{" "}
                    {t("edited", "แก้ไข")}
                  </p>
                </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {canViewClassCount && (
                        <button
                          ...
                          title={t(
                            "View Class Count Details",
                            "ดูรายละเอียดจำนวนชั้นเรียน",
                          )}
                        >
