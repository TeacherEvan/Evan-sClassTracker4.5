                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                        <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400 mb-2">
                            ...
                            <span className="text-sm">{t("Total Actions", "การดำเนินการทั้งหมด")}</span>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                        <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400 mb-2">
                            ...
                            <span className="text-sm">{t("Items Affected", "รายการที่ได้รับผลกระทบ")}</span>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                        <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400 mb-2">
                            ...
                            <span className="text-sm">{t("Most Active", "ผู้ใช้งานมากที่สุด")}</span>
                        </div>
                        <p className="text-lg font-bold truncate">
                            {stats.mostActiveUser ? stats.mostActiveUser[0] : "-"}
                        </p>
                        <p className="text-xs text-gray-500 mt-1">
                            {stats.mostActiveUser ? `${stats.mostActiveUser[1]} actions` : "-"}
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
                        <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400 mb-2">
                            <Activity className="w-4 h-4" />
                            <span className="text-sm">{t("Most Common", "การดำเนินการที่พบบ่อย")}</span>
                        </div>
                        <p className="text-sm font-bold truncate">
                            {stats.mostCommonAction ? formatAction(stats.mostCommonAction[0]) : "-"}
                        </p>
                        <p className="text-xs text-gray-500 mt-1">
                            {stats.mostCommonAction ? `${stats.mostCommonAction[1]} times` : "-"}
                        </p>
                    </div>
                </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        >
                            ...
                            <option value="delete_class">{t("Delete Class", "ลบคลาส")}</option>
                            <option value="bulk_delete">{t("Bulk Delete", "ลบหลายรายการ")}</option>
                            <option value="update_user">{t("Update User", "อัปเดตผู้ใช้")}</option>
                            <option value="create_school">{t("Create School", "สร้างโรงเรียน")}</option>
                            <option value="delete_student">{t("Delete Student", "ลบนักเรียน")}</option>
                        </select>
                    </div>
