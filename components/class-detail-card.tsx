                ...
                <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            {classData.additionalStudentNames.length > 0 && (
                                <span className="text-sm text-gray-500 dark:text-gray-400">
                                    +{classData.additionalStudentNames.length} {t("more", "เพิ่มเติม")}
                                </span>
                            )}
                        </div>
                        <div className="flex flex-wrap gap-3 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span>{language === "th" ? classData.locationNameTh : classData.locationName}</span>
                            </div>
                        </div>
                    </div>
                    <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            {classData.studentCount} {classData.studentCount === 1 ? t("student", "นักเรียน") : t("students", "นักเรียน")}
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h4 className="font-semibold text-sm text-gray-900 dark:text-gray-100">
                                    {t("All Students in This Class", "นักเรียนทั้งหมดในชั้นเรียนนี้")}
                                </h4>
                            </div>
                            <ul className="space-y-1 ml-6">
                                <li className="text-sm text-gray-700 dark:text-gray-300">
                                    • {classData.primaryStudentName} <span className="text-xs text-gray-500">({t("Primary", "หลัก")})</span>
                                </li>
                    ...
                    {allNotesForClass === undefined ? (
                        ...
                        <div className="space-y-3">
                            {postClassNotes.map((note) => (
                                <div key={note._id} className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                                    <div className="flex items-center gap-2 mb-2">
                                    ...
                                    {note.attendance && (
                                        <div className="mb-2">
                                            ...
                                            <span className={`ml-2 text-xs px-2 py-0.5 rounded-full ${note.attendance === "present"
                                    ...
                                    {(note.notes || note.notesTh) && (
                                        <div className="mb-2">
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                                {language === "th" ? (note.notesTh || note.notes) : note.notes}
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    {(note.homework || note.homeworkTh) && (
                                        <div className="mb-2">
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                                {language === "th" ? (note.homeworkTh || note.homework) : note.homework}
                                            </p>
                                        </div>
                                    )}
