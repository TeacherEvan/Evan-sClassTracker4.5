...
export function PrivateClassesSeedButton() {
  const { t } = useLanguage();
  const seedPrivateClasses = useMutation(
    api.seedPrivateClasses.seedPrivateClasses,
  );
  const checkPrivateClasses = useMutation(
    api.seedPrivateClasses.checkPrivateClasses,
  );
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm">
                ...
                >
                  <span className="font-medium">{t("Teacher", "ครู")}:</span> T.{" "}
                  {result.teacher}
                </p>
                <p
                  className={
                ...
                >
                  <span className="font-medium">
                    {t("Weeks Created", "สัปดาห์ที่สร้าง")}:
                  </span>{" "}
                  {result.weeksCreated}
                </p>
                <p
                ...
                >
                  <span className="font-medium">
                    {t("Bookings Created", "คลาสที่สร้าง")}:
                  </span>{" "}
      ...
      <div className="mt-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
        ...
        <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
          <li>
            • <strong>T. Che:</strong> 5 days/week, OLD MUSIC TOILET (60
            classes)
          </li>
          <li>
            • <strong>T. Cale:</strong> 5 days/week, Big kitchen/OLD TEG (59
            classes + special cases)
          </li>
          <li>
            • <strong>T. Lee:</strong> 4 days/week, PLAY ROOM B.5 (45 classes +
            trial students)
          </li>
          <li>
            • <strong>{t("Duration", "ระยะเวลา")}:</strong> Nov 4, 2025 - Jan
            24, 2026 (12 weeks)
          </li>
          <li>
            • <strong>{t("Time", "เวลา")}:</strong> 15:00-16:00 (3:00 PM - 4:00
            PM)
          </li>
        </ul>
      </div>
