      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Manual testing for items 1-6 from
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-gray-900 dark:text-white">
                {currentUser?.lastDeviceUpdate
                  ? new Date(currentUser.lastDeviceUpdate).toLocaleTimeString()
                  : "N/A"}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mt-6">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <p>
              <strong>Test 1-3 (Device Detection):</strong> View this page on
              different devices (phone, tablet, desktop)
            </p>
            <p>
              <strong>Test 4 (Resize):</strong> Resize your browser window and
              watch the device type change
            </p>
            <p>
              <strong>Test 5 (DB Sync):</strong> Check that deviceType matches
              in both local and database
            </p>
            <p>
              <strong>Test 6 (Service Worker):</strong> Ensure service worker is
              registered (check DevTools → Application → Service Workers)
            </p>
          </div>
