          ...
          <div className="relative">
            ...
            <div className="flex justify-between mt-2">
              {steps.map((step, index) => {
                ...
                const isAccessible =
                  index <= Math.max(...Array.from(completedSteps), -1) + 1;
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center flex-1 min-w-0 px-1 transition-opacity ${
                      isAccessible
                        ? "cursor-pointer hover:opacity-80"
                        : "cursor-not-allowed opacity-40"
                    }`}
                    aria-label={`${t("Step", "ขั้นตอน")} ${index + 1}: ${t(
                      step.titleEn,
                      step.titleTh,
                    )}`}
