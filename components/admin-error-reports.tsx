...
export function AdminErrorReports({ userId }: AdminErrorReportsProps) {
    ...
    const [statusFilter, setStatusFilter] = useState<"new" | "acknowledged" | "resolved" | "closed" | undefined>(undefined);
    const [severityFilter, setSeverityFilter] = useState<"low" | "medium" | "high" | "critical" | undefined>(undefined);
    const [selectedError, setSelectedError] = useState<Id<"errorReports"> | null>(null);
    ...
    const handleUpdateStatus = async (
        ...
        try {
            ...
            const errorMessage = err instanceof Error ? err.message : "Failed to update error report";
            toast.error(
                errorMessage,
                "ไม่สามารถอัปเดตรายงานข้อผิดพลาดได้"
            );
        }
    };
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        {t("User-reported errors and system issues", "ข้อผิดพลาดที่ผู้ใช้รายงานและปัญหาระบบ")}
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            value={statusFilter || ""}
                            onChange={(e) => setStatusFilter((e.target.value as "new" | "acknowledged" | "resolved" | "closed") || undefined)}
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => setSeverityFilter((e.target.value as "low" | "medium" | "high" | "critical") || undefined)}
                            className="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:text-white"
                        >
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {errorReports === undefined ? (
                                ...
                                errorReports.map((error) => (
                                    <tr key={error._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <div className="p-4 md:p-6 space-y-4 md:space-y-6">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 dark:text-white text-sm">
                                        {errorDetail.browser || "Unknown"} {errorDetail.browserVersion}
                                    </p>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {errorDetail.status !== "acknowledged" && (
                                        <button
                                            onClick={() => handleUpdateStatus(errorDetail._id, "acknowledged")}
                                    ...
                                    {errorDetail.status !== "resolved" && (
                                        <button
                                            onClick={() => handleUpdateStatus(errorDetail._id, "resolved")}
                                    ...
                                    {errorDetail.status !== "closed" && (
                                        <button
                                            onClick={() => handleUpdateStatus(errorDetail._id, "closed")}
