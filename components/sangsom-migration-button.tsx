...
export function SangsomMigrationButton({
  userId,
}: SangsomMigrationButtonProps) {
  const { t } = useLanguage();
  const migrateStudents = useMutation(
    api.migrateSangsomStudentsToEvents.migrateSangsomStudentsToEvents,
  );
  const deleteStudents = useMutation(
    api.migrateSangsomStudentsToEvents.deleteSangsomStudents,
  );
    ...
    <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-6">
      ...
      <div className="mt-4 text-xs text-orange-600 dark:text-orange-400">
        ...
        {t(
          ...
          "คำเตือน: การดำเนินการเหล่านี้ไม่สามารถยกเลิกได้!",
        )}
      </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-sm w-full">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                onClick={
                  deleteStep === 1 ? () => setDeleteStep(2) : executeDelete
                }
