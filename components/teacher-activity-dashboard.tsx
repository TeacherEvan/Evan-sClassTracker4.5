...
export function TeacherActivityDashboard({
  ...
  const [activeView, setActiveView] = useState<"cancellations" | "logs">(
    "cancellations",
  );
  ...
  const [requestToReject, setRequestToReject] =
    useState<Id<"cancellationRequests"> | null>(null);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          ...
          <div className="space-y-1 text-sm">
            <p>
              <span className="font-medium">{t("Teacher:", "ครู:")}</span>{" "}
              {teacher.username}
            </p>
            <p>
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
        ...
        <p className="text-sm">
          {language === "en" ? request.reason : request.reasonTh}
        </p>
      </div>
