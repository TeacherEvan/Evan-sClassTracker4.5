...
export function TeacherHelperAdmin({ currentUser }: TeacherHelperAdminProps) {
  ...
  const initializeDefaults = useMutation(
    api.teacherResources.initializeDefaults,
  );

  const [isAdding, setIsAdding] = useState(false);
  const [editingId, setEditingId] = useState<Id<"teacherResources"> | null>(
    null,
  );
  ...
  const [resourceToDelete, setResourceToDelete] =
    useState<Id<"teacherResources"> | null>(null);
      ...
      setError(
        err instanceof Error
          ...
          : t(
              ...
              "ไม่สามารถเริ่มต้นค่าเริ่มต้นได้",
            ),
      );
    } finally {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("categoryTh", e.target.value)
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleInputChange("descriptionTh", e.target.value)
                }
                rows={3}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
